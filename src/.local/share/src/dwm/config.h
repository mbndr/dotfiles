...
static Key keys[] = {
	...
	{ MODKEY,                       XK_b,      togglebar,      {0} }, // toggle topbar
	{ MODKEY,                       XK_j,      focusstack,     {.i = +1 } }, // move focus
	{ MODKEY,                       XK_k,      focusstack,     {.i = -1 } }, // move focus
	//{ MODKEY,                       XK_i,      incnmaster,     {.i = +1 } },
	//{ MODKEY,                       XK_d,      incnmaster,     {.i = -1 } },
	{ MODKEY,                       XK_h,      setmfact,       {.f = -0.05} }, // move master size
	{ MODKEY,                       XK_l,      setmfact,       {.f = +0.05} }, // move master size
	{ MODKEY,                       XK_Return, zoom,           {0} }, // move selected to master
	...
	{ MODKEY,                       XK_space,  togglefloating, {0} }, // toggle selected float
	{ MODKEY,                       XK_0,      view,           {.ui = ~0 } },// display all tags
	{ MODKEY|ShiftMask,             XK_0,      tag,            {.ui = ~0 } }, // move window to tag
	{ MODKEY,                       XK_comma,  focusmon,       {.i = -1 } }, // change monitor focus
	{ MODKEY,                       XK_period, focusmon,       {.i = +1 } }, // change monitor focus
	//{ MODKEY|ShiftMask,             XK_comma,  tagmon,         {.i = -1 } },
	//{ MODKEY|ShiftMask,             XK_period, tagmon,         {.i = +1 } },
	TAGKEYS(                        XK_1,                      0) // display tag X...
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
	TAGKEYS(                        XK_5,                      4)
	{ MODKEY|ShiftMask,             XK_q,      quit,           {0} }, // quit dwm (restarts)
	// Gaps
