...
//static const char col_primary[]     = "#226e8c"; // custom color
static const char col_primary[]     = "#a83920"; // custom color
...
static Key keys[] = {
	...
	// Spawning (rest in sxhkd)
	{ SuperMask,                    XK_p,      spawn,          {.v = dmenucmd } },
	{ SuperMask,                    XK_Return, spawn,          {.v = termcmd } },
